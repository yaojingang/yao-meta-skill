...
| `governed-incident-command` | `keep_current` | `Current` | True | 1.0 | watch | no_candidate_outperformed_current, current_holdout_gap_present, current_holdout_risk, adversarial_watch_risk | Keep the current description and open a new candidate only when fresh route evidence appears. |
