...
| Trust | `0` secret findings, `1` pinned dependency file, `35` declared internal modules, `3 / 3` network-capable scripts covered by bounded host policy, `86 / 86` CLI help smoke checks passing across `121` scripts, source-contract hash scope explicit |
