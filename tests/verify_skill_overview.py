...
def main() -> None:
    ...
    assert ".metrics-primary {\n      display: grid;\n      grid-template-columns: minmax(0, 1.08fr) minmax(320px, 0.92fr);" in css_contract, css_contract[:9000]
    assert ".metric-detail-grid {\n      grid-template-columns: repeat(auto-fit, minmax(min(100%, 320px), 1fr));" in css_contract, css_contract[:9000]
